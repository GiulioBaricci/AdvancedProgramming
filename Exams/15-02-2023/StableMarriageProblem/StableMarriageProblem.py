def find_stable(menDict, womenDict):
    ...
    return find_couples(menDict, womenDict, currentMenDict, currentWomenDict, [])


def find_couples(menDict, womenDict, currentMenDict, currentWomenDict, couples):

    menList = [manKey for manKey in currentMenDict]
    womenList = [womenKey for womenKey in currentWomenDict]
    ...
    if(len(menList) == 0):
        ...
        if(len(coppia) > 0):
            ...
            return find_couples(menDict, womenDict, currentMenDict, currentWomenDict, couples)
